...
function getLocalFallbackResponse(question: string) {
  ...
  if (includesAny(normalized, ["kentsel donusum", "donusum", "riskli yapi", "riskli bina"])) {
    return "Akinal İnşaat kentsel dönüşüm süreçlerinde ön değerlendirme, proje planlama ve uygulama konularında destek sağlar. Sürecin detayları yapı ve arsa durumuna göre değiştiği için ön görüşme için WhatsApp üzerinden ekibimize ulaşabilirsiniz. Kentsel dönüşüm sayfası: /kentsel-donusum";
  }
  ...
  if (includesAny(normalized, ["hizmet", "ne yapiyorsunuz", "ne is yapiyorsunuz", "insaat"])) {
    return "Akinal İnşaat; kentsel dönüşüm, kat karşılığı inşaat, anahtar teslim inşaat ve proje geliştirme alanlarında hizmet verir. İhtiyacınıza göre doğru yönlendirme için WhatsApp üzerinden kısa bir ön görüşme yapabilirsiniz.";
  }

  return "Bu konuda en doğru yönlendirmeyi satış ekibimiz yapabilir. Akinal İnşaat projeleri, kentsel dönüşüm, kat karşılığı inşaat ve iletişim konularında WhatsApp üzerinden bize ulaşabilirsiniz.";
}
